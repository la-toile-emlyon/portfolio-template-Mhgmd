...
fetch('data.json')
  ...
  .then(function (data) {
    ...
    function genererTags(tags) {
      let html = '<span class="tag">HTML</span><span class="tag">CSS</span>';
